...
const ErrorAlert = ({ setShowAlert, errorMsg }: Props) => {
  return (
    <div
      ...
      className="hs-overlay fixed top-0 left-0 z-60 h-full w-full overflow-x-hidden overflow-y-auto bg-black/20"
    >
      <div className="hs-overlay-open:opacity-100 hs-overlay-open:duration-500 m-3 transition-all sm:mx-auto sm:w-full sm:max-w-lg">
        <div
          id="dismiss-alert"
          onClick={(e) => {
            e.stopPropagation();
